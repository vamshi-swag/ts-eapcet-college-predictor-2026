...
function printOptionForm() {
  ...
  const html = `<!DOCTYPE html><html><head>
    ...
    <title>TS-EAPCET Option Form</title>
    <style>
      *{box-sizing:border-box;margin:0;padding:0}
      ...
      table{border-collapse:collapse;width:100%;margin-top:12px;font-size:10px;table-layout:fixed}
      th,td{border:1px solid #ccc;padding:4px 5px;word-break:break-word;overflow-wrap:break-word}
      th{background:#222;color:#fff;text-align:center;font-size:9px;padding:5px 4px}
      td:nth-child(3),td:nth-child(5){text-align:left}
      td:not(:nth-child(3)):not(:nth-child(5)){text-align:center}
    ...
    <p style="font-size:10px;color:#666">Cutoffs from 2025 Final Phase (${cgKey}). Verify before submission.</p>
    <table>
      <colgroup>
        <col style="width:5%">
        <col style="width:10%">
      ...
      <thead><tr><th>#</th><th>Code</th><th>College</th><th>Br.</th><th>Branch Name</th><th>Cutoff</th></tr></thead>
      <tbody>${rows}</tbody>
    </table>
    <p style="margin-top:14px;font-size:10px;color:#888">Generated by MarsMate EAPCET · ${new Date().toLocaleDateString('en-IN')}</p>
  </body></html>`;
